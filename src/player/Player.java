...
public class Player {
	...
	public String toString() {
		return new StringBuilder().append("{").append(this.getName()).append(":").append("(Deck Name = ")
				.append(this.getDeck()).append(" )").append(":  [").append("DMG:").append(this.getCurrentDamagePoint())
				.append("] ").toString();
	}

	public String toStringShortVer() {
		return new StringBuilder().append("{").append(this.getName()).append(":").append("DMG:")
				.append(this.getCurrentDamagePoint()).append("] ").toString();
	}
